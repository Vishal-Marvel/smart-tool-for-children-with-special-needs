    ...
    return (
        <div className={"pr-4 pt-1"}>
            <button
                type="button"
                onClick={toggleTheme}
                className="flex justify-center items-center w-7 h-7 rounded-3xl bg-zinc-600 cursor-pointer z-10"
            >
                {theme === "light" ? (
                    <svg
                        className="relative w-5 h-5 fill-white"
                    ...
                    <svg
                        className="relative  w-5 md:w-6 h-5 md:h-6 fill-white"
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
